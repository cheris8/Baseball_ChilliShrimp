...
pitcher = read.csv('C:/Users/seungjun/Desktop/baseball/Baseball_ChilliShrimp/data/pitcher_all.csv',header=T)
head(pitcher)
...
dummy = pitcher %>%
  select(c(X,T_ID,year,month,P_ID,TB_SC_B,TB_SC_T,WLS_D,WLS_L,WLS_ND,WLS_S,WLS_W,START_CK,RELIEF_CK,CG_CK,
...
pitcher_selection = cbind(pitcher,dummy)
...
write.csv(pitcher_selection, 'C:/Users/seungjun/Desktop/baseball/Baseball_ChilliShrimp/data/pitcher_feature_selection.csv')
