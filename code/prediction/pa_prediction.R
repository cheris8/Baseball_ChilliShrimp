...
predicted_pa = read_csv("https://raw.githubusercontent.com/njj06135/Baseball_ChilliShrimp/master/data/predicted_pa_per_game.csv")
...
write.csv(predicted_pa, "prediction.csv", row.names = FALSE)
